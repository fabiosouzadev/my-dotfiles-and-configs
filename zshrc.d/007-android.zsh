...
export PATH=$ANDROID_HOME/emulator:$ANDROID_HOME/cmdline-tools/homebrew/bin:$ANDROID_HOME/platform-tools:$ANDROID_HOME/build-tools/$(ls $ANDROID_HOME/build-tools | sort | tail -1):$PATH
